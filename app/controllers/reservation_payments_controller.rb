class ReservationPaymentsController < ApplicationController
    ...
    def create
        stripe_card = Stripe::Customer.create_source(stripe_customer.id, { source: payment_params[:stripeToken] })
    ...
    private
    def payment_params
        params.permit(:stripeToken, :property_id, :user_id, :checkin_date, :checkout_date, :nights,
